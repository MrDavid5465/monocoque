...
echo "  - Wrapper scripts ($BIN_DIR/start-simd-dev, start-monocoque-dev, test-monocoque-dev)"
...
rm -f "$BIN_DIR/start-simd-dev"
rm -f "$BIN_DIR/start-monocoque-dev"
rm -f "$BIN_DIR/test-monocoque-dev"
